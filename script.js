...
const newstr = strings.filter(function(item){
...
const findingIndex = ranks.findIndex((item)=>{
  return item==7;
})
...
const checkP = positive.every(function(item){
  return item>0;
})
console.log(checkP)
...
const person = {
  ...
  vehicles: {
    car: 'limousine',
    bike: 'ktm-duke',
    plane: 'lufthansa', //different from Air123
  },
